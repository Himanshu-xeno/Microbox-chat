...
//       >
//         <div className="relative">
//           <div className="w-12 h-12 flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-500 text-white rounded-full font-bold shadow-md">
//             G
//           </div>
//         </div>
//         <div className="flex flex-col text-left flex-1 min-w-0">
//           <span className="font-semibold text-slate-900 dark:text-white truncate">Group Chat</span>
//           <span className="text-xs text-slate-500 dark:text-slate-400 truncate">Community</span>
//         </div>
//       </button>
...
//             key={u._id}
//             onClick={() =>
//               onSelect({ id: u._id, name: u.name, email: u.email, isGroup: false, publicKey: u.publicKey })
//             }
...
//           >
//             <div className="relative">
//               <div className="w-12 h-12 flex items-center justify-center bg-gradient-to-br from-purple-500 to-pink-500 rounded-full text-white font-bold shadow-md">
//                 {u.name.charAt(0).toUpperCase()}
//               </div>
//               <span
...
//             {unread > 0 && (
//               <div className="absolute right-3 top-1/2 -translate-y-1/2 min-w-[20px] h-5 bg-red-500 text-white text-xs font-bold px-1.5 rounded-full flex items-center justify-center">
//                 {unread > 99 ? "99+" : unread}
//               </div>
//             )}
//           </button>
